...
public class LoginPage extends AbstractPage {
	...
	// google Login
	private By loginLogoLocator            = By.cssSelector("#logo");
	private By loginBtnLocator       	   = By.cssSelector("#Login");
	private By usernameFieldLocator        = By.cssSelector("#username");
