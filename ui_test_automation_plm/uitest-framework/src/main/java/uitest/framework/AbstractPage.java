...
public abstract class AbstractPage {
	...
	protected AbstractPage(WebDriver driver) {
		...
		this.PAGE_WAIT_TIME = (timeout==null||timeout.trim().equals(""))==true? DEFAULT_TIMEOUT:Integer.parseInt(timeout.trim());
		this.helper = new ElementHelper(driver, ELEMENT_WAIT_TIME);
		this.helper = new ElementHelper(driver, PAGE_WAIT_TIME);
